package com.example.sadic.travelerapp.ui.login;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(user != null) {
                    SharedPref.write(SharedPref.DISPLAY_NAME, user.getDisplayName());
                    SharedPref.write(SharedPref.EMAIL, user.getEmail());
                    SharedPref.write(SharedPref.MOBILE, user.getPhoneNumber());
                    SharedPref.write(SharedPref.PHOTO_URL, user.getPhotoUrl().toString());
                    Log.d(TAG, "onAuthStateChanged: user is logged in: " + user.getEmail());
                    Log.d(TAG, "onAuthStateChanged: user name: " + user.getDisplayName());
                    Log.d(TAG, "onAuthStateChanged: user phoneNumb: " + user.getPhoneNumber());
                } else {
...
//                break;
    ...
    private void signIn() {
        Log.d(TAG, "signIn: USERNAME: " + SharedPref.read(SharedPref.DISPLAY_NAME, ""));
